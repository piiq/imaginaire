...
# Legacy GPU support
# This is the local installer for machines with old GPUs
# As of v3.1.0 pytorch is not bundled with support for GPUs that have
# CUDA capability 5.0 and lower. To enable this support pytorch sould be built from sources
...
conda install -y torchvision cudatoolkit=10.2 -c pytorch
